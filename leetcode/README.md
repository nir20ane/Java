...
4 | [Product of Array Except Itself](https://leetcode.com/problems/product-of-array-except-self/description) | medium | [left side product x right side product](https://github.com/nir20ane/Java/blob/master/leetcode/ProductofArrayExceptItself.java)
5 | [Meeting Rooms](https://leetcode.com/problems/meeting-rooms/description) | easy | [sort start and end, if they intersect, return false](https://github.com/nir20ane/Java/blob/master/leetcode/MeetingRooms.java)
6 | [Meeting Rooms II](https://leetcode.com/problems/meeting-rooms-ii/description) | medium | [sort start and end, rooms, free](https://github.com/nir20ane/Java/blob/master/leetcode/MeetingRoomsII.java)
7 | [FizzBuzz](https://leetcode.com/problems/fizz-buzz/description) | easy | [if and else loop](https://github.com/nir20ane/Java/blob/master/leetcode/FizzBuzz.java)
8 | [Reverse Integer](https://leetcode.com/problems/reverse-integer/description) | easy | [Reverse one by one, check for overflow of reverse](https://github.com/nir20ane/Java/blob/master/leetcode/ReverseInteger.java)
9 | [Container With MostWater](https://leetcode.com/problems/container-with-most-water/description) | medium | [maxwater based on height, two pointers](https://github.com/nir20ane/Java/blob/master/leetcode/ContainerWithMostWaterr.java)
10 | [LRU Cache](https://leetcode.com/problems/lru-cache/description) | hard | [Dictionary and Doubly Linked List](https://github.com/nir20ane/Java/blob/master/leetcode/LRUCache.java)
11 | [Median of Two Sorted Arrays](https://leetcode.com/problems/median-of-two-sorted-arrays/description) | hard | [imin, imax, m and n variables](https://github.com/nir20ane/Java/blob/master/leetcode/MedianofTwoSortedArrays.java)
12 | [Alien Dictionary](https://leetcode.com/problems/alien-dictionary/description) | hard | [Use Dict with chr and list and dict with char and int](https://github.com/nir20ane/Java/blob/master/leetcode/AlienDictionary.java)
13 | [License Key Formatting](https://leetcode.com/problems/license-key-formatting/description) | easy | [Use string and count, reverse at the end](https://github.com/nir20ane/Java/blob/master/leetcode/LicenseKeyFormatting.java)
...
15 | [Generate Paranthesis](https://leetcode.com/problems/generate-parentheses/description) | medium | [using left param and right param](https://github.com/nir20ane/Java/blob/master/leetcode/GenerateParanthesis.java)
16 | [Jewels and Stones](https://leetcode.com/problems/jewels-and-stones/description) | easy | [using set](https://github.com/nir20ane/Java/blob/master/leetcode/JewelsStones.java)
17 | [Letter Combinations of a Phone Number](https://leetcode.com/problems/letter-combinations-of-a-phone-number/description) | medium | [using dictionary](https://github.com/nir20ane/Java/blob/master/leetcode/LetterCombinationsofPhoneNumber.java)
18 | [Next Permutation](https://leetcode.com/problems/next-permutation/description) | medium | [using swap and reverse](https://github.com/nir20ane/Java/blob/master/leetcode/NextPermutation.java)
19 | [Palindrome Numer](https://leetcode.com/problems/palindrome-number/description) | easy | [reverse and compare](https://github.com/nir20ane/Java/blob/master/leetcode/PalindromeNumber.java)
20 | [Subdomain Visit Count](https://leetcode.com/problems/subdomain-visit-count/description) | easy | [substring and arraylist](https://github.com/nir20ane/Java/blob/master/leetcode/SubDomainVisitCount.java)
21 | [Subarray Sum Equals K](https://leetcode.com/problems/subarray-sum-equals-k/description) | medium | [map for presum, sum-k](https://github.com/nir20ane/Java/blob/master/leetcode/SubArraySumEqualsK.java)
22 | [Roman to Integer](https://leetcode.com/problems/roman-to-integer/description) | easy | [dictionary and str to list](https://github.com/nir20ane/Java/blob/master/leetcode/RomantoInteger.java)

# Dynamic Programming
No. | Problem | Diffculty | Hint(Solution in hyperlink)
--- | ------- | --- | ---
1 | [Regular Expression Matching](https://leetcode.com/problems/regular-expression-matching/description) | hard | [edge cases, increment both lengths, 2D array, 2 cases](https://github.com/nir20ane/Java/blob/master/leetcode/RegularExpMatching.java)
2 | [Coin Change](https://leetcode.com/problems/coin-change/description) | medium | [Dynamic programming](https://github.com/nir20ane/Java/blob/master/leetcode/CoinChange.java)
3 | [Word Break](https://leetcode.com/problems/word-break/description) | medium | [Dynamic programming](https://github.com/nir20ane/Java/blob/master/leetcode/WordBreak.java)
